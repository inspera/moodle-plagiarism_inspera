...
$string['resubmit_bulk_error'] = 'No records were resubmitted. Only records in error status are eligible.';
$string['resubmit_bulk_success'] = 'Resubmit processed {$a->selected} selected records: {$a->recovered} recovered immediately, {$a->queued} queued for fresh submission.';
$string['resubmit_bulk_success_skipped'] = 'Resubmit processed {$a->selected} selected records: {$a->recovered} recovered immediately, {$a->queued} queued for fresh submission. {$a->skipped} skipped (status was not error or record not found).';
