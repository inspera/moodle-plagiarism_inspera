...
$string['deletecheck'] = 'Are you sure you want to delete the selected submission record?';
...
$string['errorexcludesourcethreshold'] = 'Please enter an integer threshold between 1 and 100.';
...
$string['errorsonlymanagement'] = 'Show only errors in Submissions Management';
$string['errorsonlymanagement_help'] = 'If enabled, the Submissions Management page will default to only showing submissions with errors, and the status filter will be restricted to only error states.';
$string['errorsonlymanagementsettingsheader'] = 'Submissions Management settings';
...
$string['filesresubmittednone'] = 'Resubmit blocked: no selected files were eligible. Only "Error" and "External Error" statuses can be resubmitted.';
$string['filesresubmittedpartial'] = '{$a->eligible} of {$a->selected} selected files were queued for resubmission. Non-eligible statuses were skipped.';
...
$string['originality_enable_exclude_source_criteria'] = 'Exclude Source Criteria';
$string['originality_enable_exclude_source_criteria_help'] = 'Sources below the specific threshold are excluded from the Originality Report.';
...
$string['originality_enable_whitelist_characters'] = 'Whitelist characters';
$string['originality_enable_whitelist_characters_help'] = 'Characters to be excluded from the text manipulation report.';
$string['originality_exclude_source_threshold'] = 'Exclude source threshold (%)';
$string['originality_exclude_source_threshold_help'] = 'Exclude sources below this percentage threshold.';
...
$string['originality_excludecitations'] = 'Exclude Citations';
$string['originality_excludecitations_help'] = 'Enabling this option will exclude citations from originality checking.';
...
$string['originality_whitelist_characters'] = 'Characters';
$string['originality_whitelist_error'] = 'Each whitelisted item must be exactly 1 or 2 characters long.';
$string['originality_whitelist_placeholder'] = 'Type 1-2 chars and press Enter';
...
$string['recordsdeleted'] = 'Successfully deleted {$a} records.';
...
$string['resubmit_bulk_error'] = 'No records were resubmitted. Records must be in Error or External Error status, or queued for more than 10 minutes; Inspera API failures may also cause recovery to be skipped.';
$string['resubmit_bulk_success'] = 'Processed {$a->selected} selected records: {$a->recovered} recovered immediately, {$a->queued} queued/resumed for processing.';
$string['resubmit_bulk_success_skipped'] = 'Processed {$a->selected} selected records: {$a->recovered} recovered immediately, {$a->queued} queued/resumed for processing. {$a->skipped} skipped (not eligible, record not found, or Inspera API failure).';
...
$string['resubmit_single_api_error'] = 'Recovery aborted: The Inspera API request failed or returned an unexpected response. The tracking record has been left untouched to prevent data loss. Please try again later.';
$string['resubmit_single_not_eligible'] = 'Resubmit is only allowed when status is Error or External Error, or queued for more than 10 minutes.';
$string['resubmit_single_not_found'] = 'Cannot resubmit: The tracking record could not be found. It may have already been deleted.';
$string['resubmit_single_queued'] = 'Submission status verified and successfully queued for processing.';
$string['resubmit_single_recovered'] = 'Submission status verified and the report was recovered immediately.';
$string['resubmit_single_skipped'] = 'Recovery aborted: The record could not be safely resubmitted (e.g., fatal/unknown Inspera API status or missing source payload). The tracking record has been updated with the available details.';
...
$string['toggleviewallsubmissions'] = 'Currently viewing: Errors Only (Click to show All Submissions)';
$string['toggleviewerrorsonly'] = 'Currently viewing: All Submissions (Click to show Errors Only)';
