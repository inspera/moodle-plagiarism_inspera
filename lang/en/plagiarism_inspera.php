...
$string['resubmit_bulk_success'] = 'Processed {$a->selected} selected records: {$a->recovered} recovered immediately, {$a->queued} queued for fresh submission.';
$string['resubmit_bulk_success_skipped'] = 'Processed {$a->selected} selected records: {$a->recovered} recovered immediately, {$a->queued} queued for fresh submission. {$a->skipped} skipped (not eligible, record not found, or Inspera API failure).';
