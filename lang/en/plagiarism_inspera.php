...
$string['resubmit_bulk_success_skipped'] = 'Processed {$a->selected} selected records: {$a->recovered} recovered immediately, {$a->queued} queued for fresh submission. {$a->skipped} skipped (status was not error or record not found).';
