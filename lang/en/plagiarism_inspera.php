...
$string['resubmit_bulk_error'] = 'No records were resubmitted. Only records in error status, or queued for more than 10 minutes, are eligible.';
...
$string['resubmit_bulk_success_skipped'] = 'Processed {$a->selected} selected records: {$a->recovered} recovered immediately, {$a->queued} queued for fresh submission. {$a->skipped} skipped (not eligible or record not found).';
