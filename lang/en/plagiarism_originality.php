...
$string['originality_advanceditems'] = 'Locked and Advanced settings';
$string['originality_advanceditems_help'] = 'The list of settings set as locked here, will be shown as locked in module settings. If so, they will be also not editable from teachers if they do not have capability \'originality:advancedsettings\'.';
